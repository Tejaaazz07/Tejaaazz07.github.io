...
export const metadata: Metadata = {
    title: {
        default: 'Tejas | Commerce, AI Automation & Financial Analytics',
        template: '%s | Tejas Portfolio',
    },
    description: 'Portfolio of Tejas - Commerce Student, AI Agent Builder, Financial & Data Analyst, and ProtoSem Innovation Engineer Trainee.',
    keywords: ['Tejas', 'portfolio', 'AI agents', 'n8n', 'financial modeling', 'ProtoSem', 'Rotaract', 'analytics'],
    authors: [{ name: 'Tejas' }],
    creator: 'Tejas',
    metadataBase: new URL('https://tejaaazz07.github.io'),
    openGraph: {
        type: 'website',
        locale: 'en_US',
        url: 'https://tejaaazz07.github.io',
        title: 'Tejas | Commerce, AI Automation & Financial Analytics',
        description: 'Portfolio of Tejas - Commerce Student, AI Agent Builder, Financial & Data Analyst, and ProtoSem Innovation Engineer Trainee.',
